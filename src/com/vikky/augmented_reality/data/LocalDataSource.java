package com.vikky.augmented_reality.data;
...
import com.vikky.augmented_reality.activity.Main;
import com.vikky.augmented_reality.ui.IconMarker;
...
public class LocalDataSource extends DataSource{
    ...
    public List<Marker> getMarkers() {
        ...
        Marker atl = new IconMarker(Main.t.getText().toString(),Main.lat,Main.lon,Main.alt, Color.DKGRAY, icon);
